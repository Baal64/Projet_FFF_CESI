...
<div class="flex flex_col flex_aic flex_sa">
	<form id="modif_feuille" method="post" action="./index.php" class="flex flex_col flex_aic">
		...
		<input type="hidden" name="modification_feuille_match" value="<?php echo $id_match; ?>">
		<button type="button" class="btn" id="valide_modif_feuille_match">Valider</button>
	</form>
